        ...
        <div className="flex flex-col lg:flex-row items-center gap-5">
          ...
          <div className="w-full lg:w-2/4 p-4 space-y-3">
            <img
              src={aboutUsImage}
              alt="About Us"
              className="mx-auto mt-12 mb-2 lg:mt-7 w-[170px] h-auto object-contain" // using h-auto and object-contain
              style={{ maxHeight: "180px" }} // or a max-height that fits your layout
            />
